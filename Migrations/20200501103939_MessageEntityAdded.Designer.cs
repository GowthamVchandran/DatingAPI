...
namespace DatingAPI.Migrations
{
    ...
    [Migration("20200501103939_MessageEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingAPI.Model.Likes", b =>
                {
            ...
            modelBuilder.Entity("DatingAPI.Model.Likes", b =>
                {
                    b.HasOne("DatingAPI.Model.User", "Likee")
                        .WithMany("Likers")
                        .HasForeignKey("LikeeID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DatingAPI.Model.User", "Liker")
                        .WithMany("Likees")
